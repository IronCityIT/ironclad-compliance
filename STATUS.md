...
**PR [#4](https://github.com/IronCityIT/ironclad-compliance/pull/4) is open. CI green at `810387b` (run 35913549518), all six jobs; green on every commit of 2026-09-16, 2026-09-17 and 2026-09-23. The product workflow has run four times as a dry run — see "Dry runs".**
